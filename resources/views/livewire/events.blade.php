        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-lg-4 pt-2 bg-white flex flex-col justify-end">
                            <label class="w-full flex flex-col items-center px-4 py-6 bg-gray-300 text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue hover:text-black">
                                <svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98 4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1zM11 11h3l-4-4-4 4h3v3h2v-3z" />
                                </svg>
                                <span class="mt-2 text-base leading-normal text-center">{{trans('lang.select_img')}}</span>
                ...
                <div class="modal-footer">
                    ...
                    <x-jet-button class="bg-blue-800 hover:bg-blue-700 active:bg-blue-800 focus:border-blue-800" >{{ trans('lang.post_event') }}</x-jet-button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
